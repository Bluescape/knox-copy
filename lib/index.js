...
(function() {
  var KeyStream, Parser, backoff, ensureBuffer, guzzle, isArray, knox, qs, stripLeadingSlash, swapPrefix, waterfall, workOffStream;
  ...
  */
  ...
  knox.prototype.copyFromBucket = function(fromBucket, fromKey, toKey, headers, cb) {
    ...
    req = this.request('PUT', encodeURI(toKey), headers);
    if (cb != null) {
